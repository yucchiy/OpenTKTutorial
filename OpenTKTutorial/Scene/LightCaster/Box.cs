    ...
    public class Box : IRenderable
    {
        ...
        public Box()
        {
            ...
            var material = new Material(
                "Custom",
                (new System.IO.StreamReader(Utility.GetEmbeddedResourceStream("Scene/Resource/LightCaster/box_vertex_shader.glsl"))).ReadToEnd(),
                (new System.IO.StreamReader(Utility.GetEmbeddedResourceStream("Scene/Resource/LightCaster/box_fragment_shader.glsl"))).ReadToEnd()
            );

            material.SetTexture(TextureUnit.Texture0, OpenTKTutorialConstant.Material.DiffuseTextureName, new Texture2D("Scene/Resource/LightCaster/crate_diffuse.png"));
